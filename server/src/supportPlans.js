...
const PLANS = {
  ...
  pro: {
    ...
    description: "Brasil, Inglaterra e Espanha, temporada atual",
    highlight: true,
    features: [
      "Campeonatos do Brasil, Inglaterra e Espanha (temporada atual) — em breve",
  ...
  enterprise: {
    ...
    description: "Brasil, Inglaterra e Espanha, com 3 anos de histórico",
    features: [
      "Tudo do plano Pro",
