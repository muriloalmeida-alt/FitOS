...
| TransferCard | Mercado, Negociação | **Resolvido**: componente criado em `S4-B3-001`, integrado de verdade em Mercado (`S4-B3-002`) e Negociação/Proposta (`S4-B3-003`) — ambas ainda em branch própria, não mescladas em `main` (ver §2 acima) |
