...
recebidos ao longo do projeto ficaram até agora fora do controle de
versão (anexos de conversa, arquivos de sessão). Esta pasta existe para
que o próximo material desse tipo já nasça aqui, em vez de se perder.

Sem convenção de nomenclatura fixa ainda — organize por assunto conforme
o material chegar (ex.: `docs/library/design/`, `docs/library/mercado/`).
